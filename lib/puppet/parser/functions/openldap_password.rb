# based on: https://github.com/camptocamp/puppet-openldap/blob/master/lib/puppet/parser/functions/openldap_password.rb
# License: Apache License 2.0
# author: https://github.com/camptocamp/puppet-openldap
require 'base64'
